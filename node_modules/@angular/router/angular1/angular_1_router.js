...
function ngOutletDirective($animate, $q, $router) {
    ...
    function outletLink(scope, element, attrs, ctrls, $transclude) {
        var Outlet = (function () {
            function Outlet(ngOutletController, router) {
                this.ngOutletController = ngOutletController;
                this.router = router;
            }
            ...
            Outlet.prototype.reuse = function (instruction) {
                ...
                if (this.currentComponent && this.currentComponent.$routerOnReuse) {
                    next = $q.when(this.currentComponent.$routerOnReuse(this.currentInstruction, previousInstruction));
                }
                return next;
            };
            Outlet.prototype.routerCanReuse = function (nextInstruction) {
                ...
                else if (this.currentComponent && this.currentComponent.$routerCanReuse) {
                    result = this.currentComponent.$routerCanReuse(nextInstruction, this.currentInstruction);
                }
                else {
            ...
            Outlet.prototype.routerCanDeactivate = function (instruction) {
                if (this.currentComponent && this.currentComponent.$routerCanDeactivate) {
                    return $q.when(this.currentComponent.$routerCanDeactivate(instruction, this.currentInstruction));
                }
                return $q.when(true);
            };
            Outlet.prototype.deactivate = function (instruction) {
                if (this.currentComponent && this.currentComponent.$routerOnDeactivate) {
                    return $q.when(this.currentComponent.$routerOnDeactivate(instruction, this.currentInstruction));
                }
                return $q.when();
            };
            Outlet.prototype.activate = function (instruction) {
                ...
                this.currentInstruction = instruction;
                var componentName = this.ngOutletController.$$componentName = instruction.componentType;
                if (typeof componentName !== 'string') {
                    throw new Error('Component is not a string for ' + instruction.urlPath);
                }
                this.ngOutletController.$$template = '<' + dashCase(componentName) + ' $router="$$router"></' + dashCase(componentName) + '>';
                this.ngOutletController.$$router = this.router.childRouter(instruction.componentType);
                this.ngOutletController.$$outlet = this;
                var newScope = scope.$new();
                newScope.$$router = this.ngOutletController.$$router;
        ...
        var parentOutlet = ctrls[0],
            thisOutlet = ctrls[1],
            router = (parentOutlet && parentOutlet.$$router) || rootRouter;
        thisOutlet.$$currentComponent = null;
        router.registerPrimaryOutlet(new Outlet(thisOutlet, router));
    }
}
/**
...
function routerTriggerDirective() {
  return {
    require: '^ngOutlet',
    priority: -1000,
    link: function(scope, element, attr, ngOutletCtrl) {
      var outlet = ngOutletCtrl.$$outlet;
      var currentComponent = outlet.currentComponent = element.controller(ngOutletCtrl.$$componentName);
      if (currentComponent.$routerOnActivate) {
        currentComponent.$routerOnActivate(outlet.currentInstruction, outlet.previousInstruction);
      }
    }
  };
}
...
angular.module('ngComponentRouter', [])
    ...
    .directive('$router', routerTriggerDirective);
/*
...
var path_recognizer_1 = routerRequire('./path_recognizer');
...
var route_recognizer_1 = routerRequire('./route_recognizer');
var route_config_impl_1 = routerRequire('./route_config_impl');
var async_route_handler_1 = routerRequire('./async_route_handler');
var sync_route_handler_1 = routerRequire('./sync_route_handler');
/**
...
var route_config_impl_1 = routerRequire('./route_config_impl');
var route_recognizer_1 = routerRequire('./route_recognizer');
var component_recognizer_1 = routerRequire('./component_recognizer');
var instruction_1 = routerRequire('./instruction');
var route_config_nomalizer_1 = routerRequire('./route_config_nomalizer');
var url_parser_1 = routerRequire('./url_parser');
...
var route_lifecycle_reflector_1 = routerRequire('./route_lifecycle_reflector');
